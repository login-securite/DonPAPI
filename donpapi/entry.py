...
from donpapi.collectors.versioncontrolsystems import VersionControlSystemsDump, TAG as VersionControlSystems
...
COLLECTORS_LIST = {
    ...
    VNCTag: VNCDump,
    WifiTag: WifiDump,
    VersionControlSystems: VersionControlSystemsDump
}
